...
public class Auto_End_High_Cone extends SequentialCommandGroup {
  /** Creates a new Auto_End_High_Cone. */
  public Auto_End_High_Cone(Drivetrain m_drivetrain, Arm m_Arm, SGripper m_sGripper) {

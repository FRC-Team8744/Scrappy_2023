...
private AHRS navigator;
  ...
  private static final double GearRatio = 8.5;
    ...
    private double m_AngleOfScoringStation = 0.0;  // Direction robot is pointed at start of match
...
//  LiveWindow.addSensor("Drivetrain", "Navigator", navigator);
    ...
    public void periodic() {
        ...
        if (DEBUG == true) {
          ...
          SmartDashboard.putNumber("Starting Position", getStartPositionDirection());
        }
 ...
 /**
  ...
  public void setStartPositionDirection() {
    m_AngleOfScoringStation = navigator.getAngle();
  }

  public double getStartPositionDirection() {
    return m_AngleOfScoringStation;
  }
}

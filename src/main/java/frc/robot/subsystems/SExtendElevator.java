...
// extendElevatorSpark.burnFlash();
    ...
    m_pidController = extendElevatorSpark.getPIDController();

    m_encoder = extendElevatorSpark.getEncoder();
    ...
    public void periodic() {
        // This method will be called once per scheduler run
         // This method will be called once per scheduler run
         if (DEBUG) {
         SmartDashboard.putNumber("ExtendElevatorOutput", extendElevatorSpark.getAppliedOutput());
         SmartDashboard.putNumber("Elevator Scale Factor", m_encoder.getPositionConversionFactor());
         }
         if (DEBUG_ENCODER) {
    ...
    public void SetExtendElevator(double Position) {
        m_pidController.setReference(Position, CANSparkMax.ControlType.kPosition);
        if (DEBUG) {
        SmartDashboard.putNumber("SetPoint", Position);
      
        }
        LastElevatorSetting = Position;
    }
    public void StopExtendElevator() {

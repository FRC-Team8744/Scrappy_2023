...
// private final ChangeLED toggleLed = new ChangeLED(m_lightbar);
  ...
  */
  private RobotContainer() {
    ...
    // SmartDashboard.putData("ChangeLED", new ChangeLED((m_lightbar)));
...
joystickButton1.onTrue( new ChangeLED(m_lightbar,0xFF, 0xFF, 00 ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

final JoystickButton joystickButton2 = new JoystickButton(joystick1, 8);        
joystickButton2.onTrue( new ChangeLED(m_lightbar,0x80, 0x00, 0x80).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
joystickButton3.onTrue( new ChangeLED(m_lightbar,0, 0, 0).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
          //  SmartDashboard.putData("Joystick Button 1",new ChangeLED(m_lightbar));

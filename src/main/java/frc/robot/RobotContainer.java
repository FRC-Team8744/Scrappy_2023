...
joystickButton1.onTrue(new ChangeLED(m_lightbar, 0, 0, 255).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        SmartDashboard.putData("Joystick Button 1",new ChangeLED(m_lightbar, 0, 0, 255));
...
joystickButton2.onTrue(new ChangeLED(m_lightbar, 255, 0, 0).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        SmartDashboard.putData("Joystick Button 2",new ChangeLED(m_lightbar, 255, 0, 0));

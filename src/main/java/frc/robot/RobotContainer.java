...
liftArmConeShelf.onTrue(new Move_Arm(m_Arm, 49.8, -17.9, 37).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
liftArmSingleCone.onTrue(new Move_Arm(m_Arm, 6.5, 0, 13).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
liftArmSingleCube.onTrue(new Move_Arm(m_Arm, 17.5, 0, 11.5).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

final JoystickButton liftArmFoldUp = new JoystickButton(joystick1, 3);
liftArmFoldUp.onTrue(new Move_Arm(m_Arm, 0, -2, -3).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
liftArmGround.onTrue(new Move_Arm(m_Arm, 0, 0, 11).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
//  liftArmMid.onTrue(new ARMMid(m_sWrist, m_sExtendElevator, m_sLiftArm, m_sGripper).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
 liftArmMid.onTrue(new Move_Arm(m_Arm, 39.3, 0, 21).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

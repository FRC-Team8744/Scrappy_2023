...
// private final ChangeLED toggleLed = new ChangeLED(m_lightbar);
  ...
  */
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putData("Zero Encoders", new AutoZeroSequence(m_Arm));
    SmartDashboard.putData("Turn", new AutoTurnToAngle(m_drivetrain, 90));
    ...
    m_Arm.setDefaultCommand(new Hold_Arm(m_Arm));
    ...
    m_chooser.addOption("Auto Short Community Low", new AutoShort(m_drivetrain,m_Arm, m_sGripper));
    m_chooser.addOption("Auto Long Community Low", new AutoLong(m_drivetrain, m_Arm, m_sGripper));
    m_chooser.addOption("Auto Middle High Cube", new Auto_Arm_High_Score(m_drivetrain, m_Arm, m_sGripper));
    m_chooser.addOption("Auto End High Cube", new Auto_End_High_Cube(m_drivetrain, m_Arm, m_sGripper));
    m_chooser.addOption("Auto End High Cone", new Auto_End_High_Cone(m_drivetrain, m_Arm, m_sGripper));
    m_chooser.addOption("Auto End High Cube 2", new Auto_End_High_Cube_2(m_drivetrain, m_Arm, m_sGripper));
    m_chooser.addOption("TurnTest", new AutoTurnToAngle(m_drivetrain, 0));
    m_chooser.addOption("Auto Middle Position No Mobility", new Auto_Arm_High_Score_NO_MOBILITY(m_drivetrain, m_Arm, m_sGripper));
    m_chooser.addOption("Practice Auto", new End_Of_Cube_2_Grabes_Cone(m_drivetrain, m_sGripper, m_Arm));
    // m_chooser.addOption("Auto End High Cube", new Auto_Arm_High_Score(m_drivetrain, m_Arm, m_sGripper));
    // m_chooser.addOption("Auto End High Cube", new Auto_Arm_High_Score(m_drivetrain, m_Arm, m_sGripper));
...
// TuneElevatorNudgeUp.onTrue(new ExtendElevator(m_sExtendEleator, Constants.kElevator_Nudge_UP).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
liftArmConeShelf.onTrue(new Move_Arm(m_Arm, 49.8, -17.9, 34).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
liftArmSingleCone.onTrue(new Move_Arm(m_Arm, 6.5, 0, 10).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
liftArmSingleCube.onTrue(new Move_Arm(m_Arm, 17.5, 0, 8.5).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

final JoystickButton liftArmFoldUp = new JoystickButton(joystick1, 3);
liftArmFoldUp.onTrue(new Move_Arm(m_Arm, 0, -2, 0).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
liftArmGround.onTrue(new Move_Arm(m_Arm, 0, 0, 14).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
//  liftArmMid.onTrue(new ARMMid(m_sWrist, m_sExtendElevator, m_sLiftArm, m_sGripper).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
 liftArmMid.onTrue(new Move_Arm(m_Arm, 39.3, 0, 24).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
gripperOpen.whileTrue(new Gripper(m_sGripper, 0.5).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
gripperClose.whileTrue(new Gripper(m_sGripper , -0.5 ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

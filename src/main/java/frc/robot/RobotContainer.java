...
// private final ChangeLED toggleLed = new ChangeLED(m_lightbar);
  ...
  */
  ...
  private RobotContainer() {
    ...
    m_drivetrain.setDefaultCommand(new AutonomousCommand(m_drivetrain, 48.0));//inches
    ...
    m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand( m_drivetrain, 48.0));//inces
...
gripperClose.onTrue(new Gripper(0, m_sGripper).withInterruptBehavior(InterruptionBehavior.kCancelSelf).withTimeout(0.5));
...
gripperOpen.onTrue(new Gripper(10, m_sGripper).withInterruptBehavior(InterruptionBehavior.kCancelSelf).withTimeout(0.5));

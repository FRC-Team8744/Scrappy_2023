...
liftArmConeShelf.onTrue(new Move_Arm(m_Arm, 49.8, -17.9, 30).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
...
liftArmGround.onTrue(new Move_Arm(m_Arm, 0, 0, 16).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
